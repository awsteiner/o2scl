...
# -*- coding: utf-8 -*-
#
# o2scl documentation build configuration file, created by
...
project = 'o2scl'
copyright = '2006-2022, Andrew W. Steiner'
...
latex_documents = [
    (master_doc, 'o2scl.tex', 'o2scl Documentation',
...
man_pages = [
    (master_doc, 'o2scl', 'o2scl Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'o2scl', 'o2scl Documentation',
     author, 'o2scl', 'One line description of project.',
     'Miscellaneous'),
]
