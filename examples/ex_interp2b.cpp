...
int main(void) {
  ...
  for(size_t k=0;k<2;k++) {
    ...
    double qual[6];
    for(size_t i=0;i<6;i++) qual[i]=0.0;
    ...
    hdf_file hf;
    if (k==0) {
      hf.open_or_create("ex_interp2b_100.o2");
    } else {
      hf.open_or_create("ex_interp2b_1000.o2");
    }
