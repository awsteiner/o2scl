...
namespace o2scl {
  ...
  // This section is preliminary work in new EOSs for
  // nstar_rot
  ...
  public:
     ...
     */
    virtual double enth_from_pr(double pr)=0.0;
    /** \brief From the enthalpy, return the pressure
     */
    virtual double pr_from_enth(double enth)=0.0;
 ...
 public:
  ...
  /** \brief Desc
   */
  class eos_nstar_rot_polytrope : public eos_nstar_rot_interp {
 ...
 public:
  ...
  eos_nstar_rot_polytrope(double index);
