...
namespace o2scl {
  ...
  /** \brief EOS for nuclear statistical equilibrium with interactions
      ...
      .. todo:: 
         ...
         - In class eos_nse_full: I don't think inc_lept_phot=false
           works because then all WS cells have infinite size because of
           no electrons. For the moment, this variable is protected to
           discourage the user from changing it.
