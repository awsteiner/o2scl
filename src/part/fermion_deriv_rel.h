...
namespace o2scl {
  ...
  */
  ...
  virtual int calc_mu(fermion_deriv &f, fp_t temper) {
	...
	std::bind(std::mem_fn<fp_t(fp_t,fermion_deriv &,fp_t)>
		  (&fermion_deriv_rel_tl<fp_t>::density_T_fun),
	...
	std::bind(std::mem_fn<fp_t(fp_t,fermion_deriv &,fp_t)>
		  (&fermion_deriv_rel_tl<fp_t>::density_mu_fun),
		  this,std::placeholders::_1,std::ref(f),temper);
	...
	std::bind(std::mem_fn<fp_t(fp_t,fermion_deriv &,fp_t)>
		  (&fermion_deriv_rel_tl<fp_t>::entropy_T_fun),
		  this,std::placeholders::_1,std::ref(f),temper);
	...
	std::bind(std::mem_fn<fp_t(fp_t,fermion_deriv &,fp_t)>
		  (&fermion_deriv_rel_tl<fp_t>::deg_density_mu_fun),
		  this,std::placeholders::_1,std::ref(f),temper);
	...
	(std::mem_fn<fp_t(fp_t,fermion_deriv &,fp_t)>
	 (&fermion_deriv_rel_tl<fp_t>::deg_density_T_fun),
	 this,std::placeholders::_1,std::ref(f),temper);
      if (intl_method==direct && ll>0.0) {
	...
	(std::mem_fn<fp_t(fp_t,fermion_deriv &,fp_t)>
	 (&fermion_deriv_rel_tl<fp_t>::deg_entropy_T_fun),
	 this,std::placeholders::_1,std::ref(f),temper);
      if (intl_method==direct && ll>0.0) {
