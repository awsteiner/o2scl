...
int main(void) {
  ...
  t.test_rel(dndm,sf.dndm,5.0e-4,"ndeg dir dndm");
  cout << endl;
  ...
  t.test_rel(dndm,sf.dndm,5.0e-4,"deg dir dndm");
  cout << endl;
  ...
  t.test_rel(dndm,sf.dndm,5.0e-4,"ndeg byp dndm");
  cout << endl;
  ...
  t.test_rel(dndm,sf.dndm,5.0e-4,"deg byp dndm");
  cout << endl;
