...
int main(void) {
  ...
  t.test_rel(GSL_CONST_MKSA_SPEED_OF_LIGHT,
	     o2scl_mksa::speed_of_light,1.0e-7,
	     "MKSA speed_of_light");
  t.test_rel(GSL_CONST_MKSA_GRAVITATIONAL_CONSTANT,
	     o2scl_mksa::gravitational_constant,3.0e-4,
	     "MKSA gravitational_constant");
  t.test_rel(GSL_CONST_MKSA_PLANCKS_CONSTANT_H,
	     o2scl_mksa::plancks_constant_h,3.0e-7,
	     "MKSA plancks_constant_h");
  t.test_rel(GSL_CONST_MKSA_PLANCKS_CONSTANT_HBAR,
	     o2scl_mksa::plancks_constant_hbar,3.0e-7,
	     "MKSA plancks_constant_hbar");
  t.test_rel(GSL_CONST_MKSA_ASTRONOMICAL_UNIT,
	     o2scl_mksa::astronomical_unit,1.0e-7,
	     "MKSA astronomical_unit");
  t.test_rel(GSL_CONST_MKSA_LIGHT_YEAR,
	     o2scl_mksa::light_year,4.0e-5,
	     "MKSA light_year");
  t.test_rel(GSL_CONST_MKSA_PARSEC,
	     o2scl_mksa::parsec,1.0e-7,
	     "MKSA parsec");
  t.test_rel(GSL_CONST_MKSA_GRAV_ACCEL,
	     o2scl_mksa::grav_accel,1.0e-7,
	     "MKSA grav_accel");
  t.test_rel(GSL_CONST_MKSA_ELECTRON_VOLT,
	     o2scl_mksa::electron_volt,1.0e-7,
	     "MKSA electron_volt");
  t.test_rel(GSL_CONST_MKSA_MASS_ELECTRON,
	     o2scl_mksa::mass_electron,4.0e-7,
	     "MKSA mass_electron");
  t.test_rel(GSL_CONST_MKSA_MASS_MUON,
	     o2scl_mksa::mass_muon,4.0e-7,
	     "MKSA mass_muon");
  t.test_rel(GSL_CONST_MKSA_MASS_PROTON,
	     o2scl_mksa::mass_proton,4.0e-7,
	     "MKSA mass_proton");
  t.test_rel(GSL_CONST_MKSA_MASS_NEUTRON,
	     o2scl_mksa::mass_neutron,4.0e-7,
	     "MKSA mass_neutron");
  t.test_rel(GSL_CONST_MKSA_RYDBERG,
	     o2scl_mksa::rydberg,4.0e-7,
	     "MKSA rydberg");
  t.test_rel(GSL_CONST_MKSA_BOLTZMANN,
	     o2scl_mksa::boltzmann,4.0e-6,
	     "MKSA boltzmann");
  t.test_rel(GSL_CONST_MKSA_BOHR_MAGNETON,
	     o2scl_mksa::bohr_magneton,4.0e-7,
	     "MKSA bohr_magneton");
  t.test_rel(GSL_CONST_MKSA_NUCLEAR_MAGNETON,
	     o2scl_mksa::nuclear_magneton,4.0e-7,
	     "MKSA nuclear_magneton");
  t.test_rel(GSL_CONST_MKSA_ELECTRON_MAGNETIC_MOMENT,
	     o2scl_mksa::electron_magnetic_moment,4.0e-7,
	     "MKSA electron_magnetic_moment");
  t.test_rel(GSL_CONST_MKSA_PROTON_MAGNETIC_MOMENT,
	     o2scl_mksa::proton_magnetic_moment,4.0e-7,
	     "MKSA proton_magnetic_moment");
  t.test_rel(GSL_CONST_MKSA_MOLAR_GAS,
	     o2scl_mksa::molar_gas,4.0e-6,
	     "MKSA molar_gas");
  t.test_rel(GSL_CONST_MKSA_STANDARD_GAS_VOLUME,
	     o2scl_mksa::standard_gas_volume,4.0e-6,
	     "MKSA standard_gas_volume");
  t.test_rel(GSL_CONST_MKSA_MINUTE,
	     o2scl_mksa::minute,1.0e-7,
	     "MKSA minute");
  t.test_rel(GSL_CONST_MKSA_HOUR,
	     o2scl_mksa::hour,1.0e-7,
	     "MKSA hour");
  t.test_rel(GSL_CONST_MKSA_DAY,
	     o2scl_mksa::day,1.0e-7,
	     "MKSA day");
  t.test_rel(GSL_CONST_MKSA_WEEK,
	     o2scl_mksa::week,1.0e-7,
	     "MKSA week");
  t.test_rel(GSL_CONST_MKSA_INCH,
	     o2scl_mksa::inch,1.0e-7,
	     "MKSA inch");
  t.test_rel(GSL_CONST_MKSA_FOOT,
	     o2scl_mksa::foot,1.0e-7,
	     "MKSA foot");
  t.test_rel(GSL_CONST_MKSA_YARD,
	     o2scl_mksa::yard,1.0e-7,
	     "MKSA yard");
  t.test_rel(GSL_CONST_MKSA_MILE,
	     o2scl_mksa::mile,1.0e-7,
	     "MKSA mile");
  t.test_rel(GSL_CONST_MKSA_NAUTICAL_MILE,
	     o2scl_mksa::nautical_mile,1.0e-7,
	     "MKSA nautical_mile");
  t.test_rel(GSL_CONST_MKSA_FATHOM,
	     o2scl_mksa::fathom,1.0e-7,
	     "MKSA fathom");
  t.test_rel(GSL_CONST_MKSA_MIL,
	     o2scl_mksa::mil,1.0e-7,
	     "MKSA mil");
  t.test_rel(GSL_CONST_MKSA_POINT,
	     o2scl_mksa::point,1.0e-7,
	     "MKSA point");
  t.test_rel(GSL_CONST_MKSA_TEXPOINT,
	     o2scl_mksa::texpoint,1.0e-7,
	     "MKSA texpoint");
  t.test_rel(GSL_CONST_MKSA_MICRON,
	     o2scl_mksa::micron,1.0e-7,
	     "MKSA micron");
  t.test_rel(GSL_CONST_MKSA_ANGSTROM,
	     o2scl_mksa::angstrom,1.0e-7,
	     "MKSA angstrom");
  t.test_rel(GSL_CONST_MKSA_HECTARE,
	     o2scl_mksa::hectare,1.0e-7,
	     "MKSA hectare");
  t.test_rel(GSL_CONST_MKSA_ACRE,
	     o2scl_mksa::acre,1.0e-7,
	     "MKSA acre");
  t.test_rel(GSL_CONST_MKSA_BARN,
	     o2scl_mksa::barn,1.0e-7,
	     "MKSA barn");
  t.test_rel(GSL_CONST_MKSA_LITER,
	     o2scl_mksa::liter,1.0e-7,
	     "MKSA liter");
  t.test_rel(GSL_CONST_MKSA_US_GALLON,
	     o2scl_mksa::us_gallon,1.0e-7,
	     "MKSA us_gallon");
  t.test_rel(GSL_CONST_MKSA_QUART,
	     o2scl_mksa::quart,1.0e-7,
	     "MKSA quart");
  t.test_rel(GSL_CONST_MKSA_PINT,
	     o2scl_mksa::pint,1.0e-7,
	     "MKSA pint");
  t.test_rel(GSL_CONST_MKSA_CUP,
	     o2scl_mksa::cup,1.0e-7,
	     "MKSA cup");
  t.test_rel(GSL_CONST_MKSA_FLUID_OUNCE,
	     o2scl_mksa::fluid_ounce,1.0e-7,
	     "MKSA fluid_ounce");
  t.test_rel(GSL_CONST_MKSA_TABLESPOON,
	     o2scl_mksa::tablespoon,1.0e-7,
	     "MKSA tablespoon");
  t.test_rel(GSL_CONST_MKSA_TEASPOON,
	     o2scl_mksa::teaspoon,1.0e-7,
	     "MKSA teaspoon");
  t.test_rel(GSL_CONST_MKSA_CANADIAN_GALLON,
	     o2scl_mksa::canadian_gallon,1.0e-7,
	     "MKSA canadian_gallon");
  t.test_rel(GSL_CONST_MKSA_UK_GALLON,
	     o2scl_mksa::uk_gallon,1.0e-7,
	     "MKSA uk_gallon");
  t.test_rel(GSL_CONST_MKSA_MILES_PER_HOUR,
	     o2scl_mksa::miles_per_hour,1.0e-7,
	     "MKSA miles_per_hour");
  t.test_rel(GSL_CONST_MKSA_KILOMETERS_PER_HOUR,
	     o2scl_mksa::kilometers_per_hour,1.0e-7,
	     "MKSA kilometers_per_hour");
  t.test_rel(GSL_CONST_MKSA_KNOT,
	     o2scl_mksa::knot,1.0e-7,
	     "MKSA knot");
  t.test_rel(GSL_CONST_MKSA_POUND_MASS,
	     o2scl_mksa::pound_mass,1.0e-7,
	     "MKSA pound_mass");
  t.test_rel(GSL_CONST_MKSA_OUNCE_MASS,
	     o2scl_mksa::ounce_mass,1.0e-7,
	     "MKSA ounce_mass");
  t.test_rel(GSL_CONST_MKSA_TON,
	     o2scl_mksa::ton,1.0e-7,
	     "MKSA ton");
  t.test_rel(GSL_CONST_MKSA_METRIC_TON,
	     o2scl_mksa::metric_ton,1.0e-7,
	     "MKSA metric_ton");
  t.test_rel(GSL_CONST_MKSA_UK_TON,
	     o2scl_mksa::uk_ton,1.0e-7,
	     "MKSA uk_ton");
  t.test_rel(GSL_CONST_MKSA_TROY_OUNCE,
	     o2scl_mksa::troy_ounce,1.0e-7,
	     "MKSA troy_ounce");
  t.test_rel(GSL_CONST_MKSA_CARAT,
	     o2scl_mksa::carat,1.0e-7,
	     "MKSA carat");
  t.test_rel(GSL_CONST_MKSA_UNIFIED_ATOMIC_MASS,
	     o2scl_mksa::unified_atomic_mass,4.0e-7,
	     "MKSA unified_atomic_mass");
  t.test_rel(GSL_CONST_MKSA_GRAM_FORCE,
	     o2scl_mksa::gram_force,1.0e-7,
	     "MKSA gram_force");
  t.test_rel(GSL_CONST_MKSA_POUND_FORCE,
	     o2scl_mksa::pound_force,1.0e-7,
	     "MKSA pound_force");
  t.test_rel(GSL_CONST_MKSA_KILOPOUND_FORCE,
	     o2scl_mksa::kilopound_force,1.0e-7,
	     "MKSA kilopound_force");
  t.test_rel(GSL_CONST_MKSA_POUNDAL,
	     o2scl_mksa::poundal,1.0e-7,
	     "MKSA poundal");
  t.test_rel(GSL_CONST_MKSA_CALORIE,
	     o2scl_mksa::calorie,1.0e-7,
	     "MKSA calorie");
  t.test_rel(GSL_CONST_MKSA_BTU,
	     o2scl_mksa::btu,1.0e-7,
	     "MKSA btu");
  t.test_rel(GSL_CONST_MKSA_THERM,
	     o2scl_mksa::therm,1.0e-7,
	     "MKSA therm");
  t.test_rel(GSL_CONST_MKSA_HORSEPOWER,
	     o2scl_mksa::horsepower,1.0e-7,
	     "MKSA horsepower");
  t.test_rel(GSL_CONST_MKSA_BAR,
	     o2scl_mksa::bar,1.0e-7,
	     "MKSA bar");
  t.test_rel(GSL_CONST_MKSA_STD_ATMOSPHERE,
	     o2scl_mksa::std_atmosphere,1.0e-7,
	     "MKSA std_atmosphere");
  t.test_rel(GSL_CONST_MKSA_TORR,
	     o2scl_mksa::torr,1.0e-7,
	     "MKSA torr");
  t.test_rel(GSL_CONST_MKSA_METER_OF_MERCURY,
	     o2scl_mksa::meter_of_mercury,1.0e-7,
	     "MKSA meter_of_mercury");
  t.test_rel(GSL_CONST_MKSA_INCH_OF_MERCURY,
	     o2scl_mksa::inch_of_mercury,1.0e-7,
	     "MKSA inch_of_mercury");
  t.test_rel(GSL_CONST_MKSA_INCH_OF_WATER,
	     o2scl_mksa::inch_of_water,1.0e-7,
	     "MKSA inch_of_water");
  t.test_rel(GSL_CONST_MKSA_PSI,
	     o2scl_mksa::psi,1.0e-7,
	     "MKSA psi");
  t.test_rel(GSL_CONST_MKSA_POISE,
	     o2scl_mksa::poise,1.0e-7,
	     "MKSA poise");
  t.test_rel(GSL_CONST_MKSA_STOKES,
	     o2scl_mksa::stokes,1.0e-7,
	     "MKSA stokes");
  t.test_rel(GSL_CONST_MKSA_FARADAY,
	     o2scl_mksa::faraday,3.0e-7,
	     "MKSA faraday");
  t.test_rel(GSL_CONST_MKSA_ELECTRON_CHARGE,
	     o2scl_mksa::electron_charge,1.0e-7,
	     "MKSA electron_charge");
  t.test_rel(GSL_CONST_MKSA_GAUSS,
	     o2scl_mksa::gauss,1.0e-7,
	     "MKSA gauss");
  t.test_rel(GSL_CONST_MKSA_STILB,
	     o2scl_mksa::stilb,1.0e-7,
	     "MKSA stilb");
  t.test_rel(GSL_CONST_MKSA_LUMEN,
	     o2scl_mksa::lumen,1.0e-7,
	     "MKSA lumen");
  t.test_rel(GSL_CONST_MKSA_LUX,
	     o2scl_mksa::lux,1.0e-7,
	     "MKSA lux");
  t.test_rel(GSL_CONST_MKSA_PHOT,
	     o2scl_mksa::phot,1.0e-7,
	     "MKSA phot");
  t.test_rel(GSL_CONST_MKSA_FOOTCANDLE,
	     o2scl_mksa::footcandle,1.0e-7,
	     "MKSA footcandle");
  t.test_rel(GSL_CONST_MKSA_LAMBERT,
	     o2scl_mksa::lambert,1.0e-7,
	     "MKSA lambert");
  t.test_rel(GSL_CONST_MKSA_FOOTLAMBERT,
	     o2scl_mksa::footlambert,1.0e-7,
	     "MKSA footlambert");
  t.test_rel(GSL_CONST_MKSA_CURIE,
	     o2scl_mksa::curie,1.0e-7,
	     "MKSA curie");
  t.test_rel(GSL_CONST_MKSA_ROENTGEN,
	     o2scl_mksa::roentgen,1.0e-7,
	     "MKSA roentgen");
  t.test_rel(GSL_CONST_MKSA_RAD,
	     o2scl_mksa::rad,1.0e-7,
	     "MKSA rad");
  t.test_rel(GSL_CONST_MKSA_SOLAR_MASS,
	     o2scl_mksa::solar_mass,5.0e-4,
	     "MKSA solar_mass");
  t.test_rel(GSL_CONST_MKSA_BOHR_RADIUS,
	     o2scl_mksa::bohr_radius,1.0e-7,
	     "MKSA bohr_radius");
  t.test_rel(GSL_CONST_MKSA_NEWTON,
	     o2scl_mksa::newton,1.0e-7,
	     "MKSA newton");
  t.test_rel(GSL_CONST_MKSA_DYNE,
	     o2scl_mksa::dyne,1.0e-7,
	     "MKSA dyne");
  t.test_rel(GSL_CONST_MKSA_JOULE,
	     o2scl_mksa::joule,1.0e-7,
	     "MKSA joule");
  t.test_rel(GSL_CONST_MKSA_ERG,
  ...
  t.test_rel(GSL_CONST_MKSA_THOMSON_CROSS_SECTION,
	     ...
	     "MKSA thomson_cross_section");
  t.test_rel(GSL_CONST_MKSA_VACUUM_PERMITTIVITY,
	     o2scl_mksa::vacuum_permittivity,1.0e-7,
	     "MKSA vacuum_permittivity");
  t.test_rel(GSL_CONST_MKSA_VACUUM_PERMEABILITY,
	     o2scl_mksa::vacuum_permeability,1.0e-7,
