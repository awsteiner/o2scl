  ...
  list={{{"schwarzchildradius","rschwarz"},
	...
	{{"planck","h","planckconstant","plancks"},
	 ...
	 o2scl_const::planck_f<double>(o2scl_const::o2scl_cgs),
         "exact",0,0,0,0,0,0,0},
	{{"reducedplanck","hbar","ħ","reducedplancks"},
	 "kg*m^2/s",o2scl_const::o2scl_mks,
	...
	{{"massjupiter","jupitermass","mjupiter","mjup","m♃"},
	...
	{{"masssaturn","saturnmass","msaturn","m♄"},"kg",o2scl_const::o2scl_mks,
	 o2scl_mks::saturn_mass,"",0,1,0,0,0,0,0},
	{{"masssaturn","saturnmass","msaturn","m♄"},"g",o2scl_const::o2scl_cgs,
	 o2scl_cgs::saturn_mass,"",0,0,0,0,0,0,0},
	{{"massuranus","uranusmass","muranus","m♅"},"kg",
	 o2scl_const::o2scl_mks,o2scl_mks::uranus_mass,"",0,1,0,0,0,0,0},
	{{"massuranus","uranusmass","muranus","m♅"},"g",
