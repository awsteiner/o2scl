...
namespace o2scl {
  ...
  template<class func_t, class func_v_t> class hcub_class {
  ...
  protected:
    ...
    static hypercube make_hypercube_range
...
#define KEY(hi) ((hi).errmax)
    ...
    /* note that heap_free does not deallocate anything referenced by
       the items */
