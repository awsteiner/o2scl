    ...
    */
    ...
    int solve_bkt_multip(fp2_t &x1, fp2_t x2, func2_t &&f, fp2_t &err,
      ...
      if (tol_loc>pow(10.0,-std::numeric_limits
        ...
        solve_bkt_int_multip(x1_fp25,
                             static_cast<o2fp_25>(x2),f,
                             tol_loc,func_tol);
        if (this->verbose>0) {
          std::cout << "root_brent_gsl::solve_bkt_multip() "
                    << "[o2fp_25]\n "
      ...
      if (tol_loc>pow(10.0,-std::numeric_limits
        ...
        solve_bkt_int_multip(x1_fp35,
                             static_cast<o2fp_35>(x2),f,
                             tol_loc,func_tol);
        if (this->verbose>0) {
          std::cout << "root_brent_gsl::solve_bkt_multip() "
                    << "[o2fp_35]\n "
      ...
      if (tol_loc>pow(10.0,-std::numeric_limits
        ...
        solve_bkt_int_multip(x1_fp50,
                             static_cast<o2fp_50>(x2),f,
                             tol_loc,func_tol);
        if (this->verbose>0) {
          std::cout << "root_brent_gsl::solve_bkt_multip() "
                    << "[o2fp_50]\n "
      ...
      if (tol_loc>pow(10.0,-std::numeric_limits
        ...
        solve_bkt_int_multip(x1_fp100,
                             static_cast<o2fp_100>(x2),f,
                             tol_loc,func_tol);
        if (this->verbose>0) {
          std::cout << "root_brent_gsl::solve_bkt_multip() "
                    << "[o2fp_100]\n "
