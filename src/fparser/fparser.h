/*
  ...
  This header file for the Function Parser library (from
...
/** \brief Parse a mathematical function specified in a string
    ...
    This is version 4.5 of the Function Parser class developed
    by Juha Nieminen and Joel Yliluoma. The full documentation is
    not given here, but can be found at 
    http://warp.povusers.org/FunctionParser/fparser.html

    This class and other related classes reside in the global
    namespace (not the \o2 namespace). 
*/
...
class FunctionParserBase
{
 public:
    ...
    /*
      AWS, 5/3/12: This subclass has been moved from below to solve
