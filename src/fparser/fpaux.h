...
*/
/** \file fpaux.h
    \brief Auxilliary definitions for the \ref FunctionParser class
*/
/***************************************************************************\
...
#if __cplusplus > 201100
    template<typename Value_t>
    inline Value_t fp_log2(const Value_t& x) { return log2(x); }
#else
    template<typename Value_t>
...
#if __cplusplus > 201100
    template<typename Value_t>
    inline Value_t fp_cbrt(const Value_t& x) { return cbrt(x); }
#else
    template<typename Value_t>
