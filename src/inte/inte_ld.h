/*
  ...
  -------------------------------------------------------------------
*/
#ifndef O2SCL_INTE_LD_H
#define O2SCL_INTE_LD_H

/** \file inte_ld.h
    \brief File defining \ref o2scl::inte_ld
*/
...
namespace o2scl {
  ...
  */
  template<class func_t=funct_ld> class inte_ld {
  ...
  */
   ...
   */
  virtual long double integ(func_t &func, long double a, long double b) {
    long double res;
  ...
  */
  virtual int integ_err(func_t &func, long double a, long double b, 
			long double &res, long double &err)=0;
  ...
  */
  long double get_error() { return interror; }
