...
int main(void) {
  ...
  t.test_rel(imn.eval(point),i2n.eval(0.4,0.5),1.0e-12,"imn vs. i2n 1");
  t.test_rel(imn.eval(point),i2p.eval(0.4,0.5),8.0e-2,"imn vs. i2p 1");
  ...
  t.test_rel(imn.eval(point),i2n.eval(0.03,1.0),1.0e-12,"imn vs. i2n 2");
  t.test_rel(imn.eval(point),i2p.eval(0.03,1.0),3.0e-2,"imn vs. i2p 2");
